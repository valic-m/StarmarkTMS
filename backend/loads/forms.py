...
class PickupForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'pickup_location': forms.Select(attrs={'class': 'form-control'}),  # Refers to ShipperReceiverCompany model
...
class DeliveryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'delivery_location': forms.Select(attrs={'class': 'form-control'}),  # Refers to ShipperReceiverCompany model
