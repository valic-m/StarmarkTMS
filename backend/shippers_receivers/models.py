...
class Location(Company):
    ...
    """
    shipping_hours_from = models.TimeField(
        blank=True,
        null=True,
        help_text="Start of shipping hours"
    )
    shipping_hours_to = models.TimeField(
        blank=True,
        null=True,
        help_text="End of shipping hours"
    )
    load_time = models.DurationField(
        blank=True,
        null=True,
        help_text="Time taken to load/unload"
    )
